                    ...
                    b.ToTable("InventoryTransactions", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_InventoryTransactions_OrderLink_MatchesType", "([Type] IN (0, 1) AND [OrderId] IS NULL) OR ([Type] IN (2, 3) AND [OrderId] IS NOT NULL)");

                            t.HasCheckConstraint("CK_InventoryTransactions_QuantityChange_MatchesType", "([Type] = 0 AND [QuantityChange] > 0) OR ([Type] = 1 AND [QuantityChange] <> 0) OR ([Type] = 2 AND [QuantityChange] < 0) OR ([Type] = 3 AND [QuantityChange] > 0)");
