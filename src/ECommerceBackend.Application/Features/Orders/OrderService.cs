...
namespace ECommerceBackend.Application.Services
{
    public sealed class OrderService : IOrderService
    {
        ...
        public Task<PagedResult<OrderSummaryResponse>> GetMyOrderSummariesAsync(
            Guid userId,
            int page,
            int pageSize,
            CancellationToken cancellationToken = default)
            => _queries.GetMyOrderSummariesAsync(
                userId,
                page,
                pageSize,
                cancellationToken);
        ...
        public Task<PagedResult<OrderSummaryResponse>> GetOrderSummariesAsync(
            OrderQueryParams queryParams,
            CancellationToken cancellationToken = default)
            => _queries.GetOrderSummariesAsync(queryParams, cancellationToken);
