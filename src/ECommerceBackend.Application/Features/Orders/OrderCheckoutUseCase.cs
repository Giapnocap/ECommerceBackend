...
namespace ECommerceBackend.Application.Services
{
    public sealed class OrderCheckoutUseCase
    {
        ...
        private async Task<CheckoutRecipient> ResolveRecipientAsync(
            Guid userId,
            PlaceOrderRequest request,
            CancellationToken cancellationToken)
        {
            var recipientName = CheckoutRequestIdentity.NormalizeOptional(
                request.RecipientName);
            var recipientPhone = CheckoutRequestIdentity.NormalizeOptional(
                request.RecipientPhone);
            if (recipientName != null && recipientPhone != null)
                return new CheckoutRecipient(recipientName, recipientPhone);
